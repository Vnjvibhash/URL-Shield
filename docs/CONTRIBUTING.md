...
You are free to propose one or more translations, or to update any existing one. Be sure of your work before providing it to the developers, who cannot verify it. You can translate it using [Weblate](https://hosted.weblate.org/engage/urlcheck/), as a [pull request](https://github.com/vnjvibhash/URL-Shield/pulls)/[issue](https://github.com/vnjvibhash/URL-Shield/issues/new) titled `{locale} Translation proposal` or by sending the files by email to [vnjvibhash/](https://github.com/vnjvibhash/).
